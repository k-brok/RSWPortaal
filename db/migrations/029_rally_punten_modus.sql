...
ALTER TABLE jurymomenten
  ADD COLUMN IF NOT EXISTS aankomst_punten_modus
...
ALTER TABLE rally_stations
  ADD COLUMN IF NOT EXISTS punten   DECIMAL(8,2) NULL    DEFAULT NULL,
...
ALTER TABLE rally_routes
  ADD COLUMN IF NOT EXISTS is_circulair TINYINT(1) NOT NULL DEFAULT 0;

-- Terugkomsttijd voor rondje-routes (startpost wordt twee keer gescand)
ALTER TABLE patrouille_bezoeken
  ADD COLUMN IF NOT EXISTS terugkomst_tijd DATETIME NULL DEFAULT NULL;
